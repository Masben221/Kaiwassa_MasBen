...
public class SpearmanAttackStrategy : IAttackable
{
    ...
    /// <summary>
    /// Рассчитывает все потенциальные клетки, которые копейщики могут атаковать, включая пустые и свои фигуры, исключая горы.
    /// Учитывает дальность 1-2 клетки по прямой, с проверкой свободного пути.
    /// </summary>
