...
/// Позволяет двигаться на 1-3 клетки по прямой или диагонали, перепрыгивая препятствия.
/// </summary>
...
/// Реализует дальний бой: атака на 1-3 клетки по прямой/диагонали через горы, но не через фигуры.
/// </summary>
